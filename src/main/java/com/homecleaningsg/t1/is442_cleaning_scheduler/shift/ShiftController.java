...
public class ShiftController {
    ...
    public ResponseEntity<String> startShift(
        ...
        try{
            ...
            return ResponseEntity.status(HttpStatus.BAD_REQUEST).body("Unable to start shift. " + e.getMessage());
        }
    }
    ...
    public ResponseEntity<String> cancelShift(@PathVariable("shiftId") Long shiftId) {
        try{
            ...
            return ResponseEntity.status(HttpStatus.BAD_REQUEST).body("Unable to cancel shift. " + e.getMessage());
        }
    }
