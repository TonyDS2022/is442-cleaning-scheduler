...
public class LeaveApplicationController {
    ...
    public ResponseEntity<?> createLeaveApplication(@PathVariable Long workerId,
                                                    ...
                                                    @RequestParam OffsetDateTime leaveStart,
                                                    @RequestParam OffsetDateTime leaveEnd,
                                                    @RequestParam(required = false) MultipartFile file) {
        try {
            // Check if file is required for medical leave
            if (leaveType == LeaveType.MEDICAL && (file == null || file.isEmpty())) {
                return ResponseEntity.status(HttpStatus.BAD_REQUEST)
                        .body("Medical leave requires a file upload");
            }
    ...
    @GetMapping("/worker/{workerId}/application")
    ...
    @GetMapping("/worker/{workerId}/application/history")
